...
struct ContentView: View {
    @EnvironmentObject var store: LoosechangeStore
    @EnvironmentObject var purchases: PurchaseManager

    @State private var showingAdd = false
    @State private var showingSettings = false
    @State private var showingPaywall = false
    @State private var editingEntry: LoosechangeEntry?
    ...
    private func entryRow(_ entry: LoosechangeEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: LoosechangeEntry? = nil, onSave: @escaping (String, Double) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existing == nil ? "Add Deposit" : "Edit Deposit")
